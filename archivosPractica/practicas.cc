...
//Animación del modelo jerárquico
void funcion_idle(){
   if(escena != nullptr)
      escena->animarModeloJerrarquico();
   glutPostRedisplay();
}


//Función llamada cuando se selecciona un botón del ratón
...
//Función llamada cuando se mueve el ratón
...
int main( int argc, char **argv )
{
   ...
   glutCreateWindow("Practicas IG: Barto Zambrana");
   ...
   cout << "ENTRO en glutMainLoop()" << endl;
   glutMainLoop();
   cout << "paso glutMainLoop();";
   return 0;
}
